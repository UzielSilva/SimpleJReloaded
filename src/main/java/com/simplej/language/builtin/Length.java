...
public class Length extends JavaProcedureRef {
    ...
    public void call(ExecutionContext ctx,
        ...
        if (o instanceof String) {
            String s = (String) o;
            ctx.evaluationStackPush(new Integer(s.length()));
        } else if (o instanceof Location[]) {
            Location[] a = (Location[]) o;
            ctx.evaluationStackPush(new Integer(a.length));
        } else
            throw new NotAnArrayOrStringException(ctx);
    }
