...
public class FileSystemSourceFinder implements SourceFinder {

    public Reader getReader(ExecutionContext ctx,
                            String filename) throws CantAccessFileException {
        try {
    ...
    public InputStream getInputStream(ExecutionContext ctx, String filename)
