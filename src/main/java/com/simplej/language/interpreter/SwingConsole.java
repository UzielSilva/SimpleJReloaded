/*
 * SwingConsole.java
 * An adaptation of BeanShell's JConsole.
 */
...
*/
public class SwingConsole extends JScrollPane
               ...
               MouseListener, ActionListener, PropertyChangeListener 
{
    ...
    public SwingConsole(InputStream cin, OutputStream cout, String title) {
        ...
        // create popup	menu
        menu = new JPopupMenu("SwingConsole	Menu");
        ...
        print(title,
              new Font("SansSerif", Font.BOLD, 12), new Color(20, 100, 20));
        println();
        print("Copyright (C) 2005,2006 Gerardo Horvilleur",
              new Font("SansSerif", Font.PLAIN, 12), new Color(20, 100, 20));
        println();
        print("http://www.simplej.com",
              new Font("SansSerif", Font.PLAIN, 12), new Color(20, 100, 20));
        println();
        interpreter = new Interpreter(getIn(), out, out);
    ...
    private String getCmd() {
        ...
        try {
            ...
            // should not happen
            System.out.println("Internal SwingConsole Error: "+e);
        }
        return s;
    }
    ...
    */
    ...
    public static void main(String[] args) {
        JFrame jf = new JFrame("SimpleJ");
        jf.getContentPane().add(
                           new SwingConsole("SimpleJ"));
